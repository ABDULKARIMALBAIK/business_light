...
class CustomerAddPage extends StatefulWidget {
  CustomerAddPage({
    ...
    viewModel.initEditCustomer(isEdit);
  }
...
class _CustomerAddPageState extends State<CustomerAddPage> {
        ...
        builder: (context, scrollController, physics) =>
            ScaffoldPage.scrollable(
              ...
              children: [
                ...
                // ),
                // InfoLabel(
                //   label: 'customer_add_infoBar_comboBox_level'.tr(),
      ...
      title: Wrap(
        ...
        children: [
          ...
          Text(widget.isEdit == 'true'
              ? 'customer_edit_header'.tr()
              : 'customer_add_header'.tr()),
        ],
      ),
        ...
        Card(
          ...
          child: Tooltip(
            ...
            message: widget.isEdit == 'true'
                ? 'customer_tooltip_editButton'.tr()
                : 'customer_tooltip_saveButton'.tr(),
            enableFeedback: true,
            child: MouseRegion(
              cursor: SystemMouseCursors.click,
              child: FilledButton(
                onPressed: () async {
                  ...
                  if (widget.isEdit == 'true') {
                    await widget.viewModel.editCustomerStorage();
                  ...
                  //! Save
                    ...
                    await widget.viewModel.addCustomerStorage();
                    // ignore: use_build_context_synchronously
                    CustomInfoBar.showDefault(
                        context: context,
  ...
  Widget name(BuildContext context) {
    return InfoLabel(
      label: 'customer_add_infoBar_name'.tr(),
      child: SizedBox(
        width: 250,
        child: TextBox(
          autocorrect: true,
  ...
  Widget email(BuildContext context) {
    return InfoLabel(
      label: 'customer_add_infoBar_email'.tr(),
      child: SizedBox(
        width: 250,
        child: TextBox(
          autocorrect: true,
  ...
  Widget password(BuildContext context) {
    return InfoLabel(
      label: 'customer_add_infoBar_password'.tr(),
      child: SizedBox(
        width: 250,
        child: TextBox(
          autocorrect: true,
  ...
  Widget phone(BuildContext context) {
    return InfoLabel(
      label: 'customer_add_infoBar_Phone'.tr(),
      child: SizedBox(
        width: 250,
        child: TextBox(
          autocorrect: true,
  ...
  Widget jobDescription(BuildContext context) {
    return InfoLabel(
      label: 'customer_add_infoBar_job_description'.tr(),
      child: SizedBox(
        width: 250,
        child: TextBox(
          autocorrect: true,
