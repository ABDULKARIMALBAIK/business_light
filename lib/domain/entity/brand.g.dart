...
const BrandSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'status': PropertySchema(
      ...
      name: r'status',
      type: IsarType.byte,
      enumMap: _BrandstatusEnumValueMap,
    )
  },
...
Brand _brandDeserialize(
  ...
  object.status = _BrandstatusValueEnumMap[reader.readByteOrNull(offsets[1])] ??
      Status.active;
  return object;
}
...
P _brandDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_BrandstatusValueEnumMap[reader.readByteOrNull(offset)] ??
          Status.active) as P;
    default:
...
const _BrandstatusEnumValueMap = {
  'active': 0,
  'inactive': 1,
};
const _BrandstatusValueEnumMap = {
  0: Status.active,
  1: Status.inactive,
};
...
extension BrandQueryFilter on QueryBuilder<Brand, Brand, QFilterCondition> {
  ...
  QueryBuilder<Brand, Brand, QAfterFilterCondition> statusEqualTo(
      Status value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'status',
  ...
  QueryBuilder<Brand, Brand, QAfterFilterCondition> statusGreaterThan(
    Status value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Brand, Brand, QAfterFilterCondition> statusLessThan(
    Status value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Brand, Brand, QAfterFilterCondition> statusBetween(
    Status lower,
    Status upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension BrandQuerySortBy on QueryBuilder<Brand, Brand, QSortBy> {
  ...
  QueryBuilder<Brand, Brand, QAfterSortBy> sortByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<Brand, Brand, QAfterSortBy> sortByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BrandQuerySortThenBy on QueryBuilder<Brand, Brand, QSortThenBy> {
  ...
  QueryBuilder<Brand, Brand, QAfterSortBy> thenByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<Brand, Brand, QAfterSortBy> thenByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.desc);
    });
  }
...
extension BrandQueryWhereDistinct on QueryBuilder<Brand, Brand, QDistinct> {
  ...
  QueryBuilder<Brand, Brand, QDistinct> distinctByStatus() {
    return QueryBuilder.apply(this, (query) {
...
extension BrandQueryProperty on QueryBuilder<Brand, Brand, QQueryProperty> {
  ...
  QueryBuilder<Brand, Status, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
